...
const styles = {
    ...
    emptyEditorTitle: { fontSize: "15px", fontWeight: "600", color: "#a0aec0", margin: 0 },
    emptyEditorText: { fontSize: "13px", color: "#4a5568", margin: 0, maxWidth: "360px" },
    ...
    emptyListText: { fontSize: "13px", color: "#4a5568", margin: 0, maxWidth: "360px" },
};
